...
<div class="container-fluid">
      <div class="row">
            ...
            <div class="col-10">
                  <div class="card">
                        <div class="card-header"><i class="ax ax-tags mr-2"></i>Show author</div>
                        <div class="card-body">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                          <input type="text" class="form-control" name="slug" id="slug" value="{{ $author->slug }}">
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="description" class="col-2 col-form-label">Description</label>
                                    <div class="col-10">
                                          <textarea type="text" class="form-control" name="description" id="description" cols="30" rows="2">{{ $author->description }}</textarea>
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="img" class="col-2 col-form-label">Image</label>
                                    <div class="col-10">
                                          <img src="{{ asset('images') . '/' . $author->img }}" alt="" name="img" id="img">
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="email" class="col-2 col-form-label">Email</label>
                                    <div class="col-10">
                                          <input type="text" class="form-control" name="email" id="email" value="{{ $author->email }}">
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="social" class="col-2 col-form-label">Social</label>
                                    <div class="col-10">
                                          <input type="text" class="form-control" name="social" id="social" value="{{ $author->social }}">
                                    </div>
                              </div>
                              <div class="col-12 border-top">
                                    <div class="float-right mt-4">
                                          <a href="{{ route('author.index') }}" class="btn btn-light">Go back</a>
                                    </div>
                              </div> 
