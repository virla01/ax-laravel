...
<div class="container-fluid">
      <div class="row">
            ...
            <div class="col-10">
                  <div class="card">
                        <div class="card-header"><i class="ax ax-tags mr-2"></i>Show source</div>
                        <div class="card-body">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                          <input type="text" class="form-control" name="slug" id="slug" value="{{ $source->slug }}">
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="description" class="col-2 col-form-label">Description</label>
                                    <div class="col-10">
                                          <textarea type="text" class="form-control" name="description" id="description" cols="30" rows="2">{{ $source->description }}</textarea>
                                    </div>
                              </div>
                              <div class="form-group row">
                                    <label for="logo" class="col-2 col-form-label">Logo</label>
                                    <div class="col-10">
                                          <img src="{{ asset('images') . '/' . $source->logo }}" alt="" name="logo" id="logo">
                                    </div>
                              </div>

                              <div class="col-12 border-top">
                                    <div class="float-right mt-4">
                                          <a href="{{ route('source.index') }}" class="btn btn-light">Go back</a>
                                    </div>
                              </div> 
