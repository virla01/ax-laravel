...
<div class="container-fluid">
      <div class="row">
            ...
            <div class="col-10">
                  <div class="card">
                        <div class="card-header"><i class="ax ax-ballot mr-2"></i>Show category</div>
                        <div class="card-body">
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                          <textarea type="text" class="form-control" name="description" id="description" cols="30" rows="2">{{ $category->description }}</textarea>
                                    </div>
                              </div>
                              <div class="col-12 border-top">
                                    <div class="float-right mt-4">
                                          <a href="{{ route('category.index') }}" class="btn btn-light">Go back</a>
                                    </div>
                              </div> 
