...
<div class="container-fluid">
      <div class="row">
            ...
            <div class="col-10">
                  <nav class="nav-bar mb-4"><a href="{{ route('category.create') }}" class="btn btn-info">Create category</a></nav>
                  <div class="card">
                        <div class="card-header"><i class="ax ax-ballot mr-2"></i>List categories</div>
                        <div class="card-body">
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td width="136">
                                                <a href="{{ route('category.show', $category->id) }}" class="btn transparent trans-info circle float-left mr-2"><i class="ax ax-eye"></i></a>
                                                <a href="{{ route('category.edit', $category->id) }}" class="btn transparent trans-success circle float-left mr-2"><i class="ax ax-edit"></i></a>
